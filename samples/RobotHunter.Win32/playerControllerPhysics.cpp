...
void PlayerControllerPhysics::Update(float deltaT)
{
...
void PlayerControllerPhysics::FixedUpdate(float deltaT)
{
...
void PlayerControllerPhysics::ApplyMomentum(float& oldValue, float& newValue, float deltaTime)
{
	float blendedValue;
