...
namespace sle
{
	...
	public:
		...
		inline math::Matrix4 GetViewMatrix() const { return m_viewMatrix.Transpose(); }
		inline math::Matrix4 GetProjectionMatrix() const { return m_projectionMatrix.Transpose(); }
		inline math::Matrix4 GetViewProjectionMatrix() const { return m_viewProjectionMatrix.Transpose(); }
		inline math::Frustum GetViewFrustum() const { return m_viewFrustum; };
